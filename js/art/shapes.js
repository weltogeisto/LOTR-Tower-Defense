/* Silhouette art — palette shapes, no emoji on canvas */
(function (global) {
  ...
  function contactShadow(ctx, size) {
    ctx.save();
  ...
  function towerArtillery(ctx, size, t) {
    ...
    ctx.fillRect(-s * 0.28, -s * 0.1, s * 0.56, s * 0.48);
    ctx.fillStyle = '#3a4658';
    ctx.beginPath();
    ...
    ctx.beginPath();
    ctx.arc(s * 0.38, -s * 0.35, s * 0.07, 0, Math.PI * 2);
    ctx.fill();
  }
  ...
  function towerSlow(ctx, size, t) {
    ...
    contactShadow(ctx, s);
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.22, -s * 0.05, s * 0.44, s * 0.42);
  ...
  function towerRapid(ctx, size, t) {
    ...
    contactShadow(ctx, s);
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.2, -s * 0.15, s * 0.4, s * 0.5);
    ctx.fillStyle = '#3a4658';
    for (let i = -1; i <= 1; i++) {
      ctx.fillRect(i * s * 0.14 - s * 0.06, -s * 0.42, s * 0.12, s * 0.28);
    }
    ctx.fillStyle = t || '#c9a227';
  ...
  function towerHero(ctx, size, t) {
    ...
    contactShadow(ctx, s);
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.26, -s * 0.05, s * 0.52, s * 0.42);
    ctx.fillStyle = '#3a4658';
    ctx.beginPath();
  ...
  const TOWERS = {
    artillery: towerArtillery,
    slow: towerSlow,
    rapid: towerRapid,
    sniper: towerSniper,
    antiAir: towerAntiAir,
    hero: towerHero
  };
  ...
  function enemyFlyer(ctx, size, accent) {
    ...
    ctx.beginPath();
    ctx.ellipse(0, s * 0.4, s * 0.28, s * 0.08, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#3a4658';
    ctx.beginPath();
    ctx.ellipse(0, 0, s * 0.22, s * 0.14, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = accent || '#6b7c93';
    ctx.beginPath();
    ctx.moveTo(-s * 0.22, 0);
  ...
  function propRock(ctx, size) {
    ...
    ctx.beginPath();
    ctx.ellipse(0, s * 0.28, s * 0.3, s * 0.1, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#3a4658';
    ctx.beginPath();
  ...
  function propTree(ctx, size) {
    ...
    ctx.fillStyle = 'rgba(0,0,0,0.35)';
    ctx.beginPath();
    ctx.ellipse(0, s * 0.32, s * 0.22, s * 0.08, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#1a1810';
    ctx.fillRect(-s * 0.05, 0, s * 0.1, s * 0.3);
    ctx.fillStyle = '#1c2c20';
    ctx.beginPath();
    ctx.moveTo(0, -s * 0.45);
  ...
  function propRuin(ctx, size) {
    ...
    ctx.beginPath();
    ctx.ellipse(0, s * 0.3, s * 0.28, s * 0.09, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.28, -s * 0.1, s * 0.2, s * 0.4);
    ctx.fillRect(s * 0.05, 0, s * 0.18, s * 0.3);
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.28, -s * 0.18, s * 0.52, s * 0.1);
  }
  ...
  function landmarkTor(ctx, size) {
    ...
    g.addColorStop(0, 'rgba(61,155,143,0.45)');
  ...
  function landmarkFeste(ctx, size) {
    ...
    ctx.beginPath();
    ctx.ellipse(0, s * 0.42, s * 0.55, s * 0.16, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = '#3a4658';
    ctx.fillRect(-s * 0.45, -s * 0.15, s * 0.9, s * 0.55);
    ctx.fillRect(-s * 0.5, -s * 0.45, s * 0.28, s * 0.85);
    ctx.fillRect(s * 0.22, -s * 0.4, s * 0.28, s * 0.8);
    ctx.fillStyle = '#3a4658';
    for (let i = 0; i < 5; i++) {
      ctx.fillRect(-s * 0.45 + i * s * 0.2, -s * 0.28, s * 0.1, s * 0.14);
    }
  ...
  function ensure(tile, dpr) {
    ...
    Object.keys(TOWERS).forEach((k) => {
      ...
      cache.towers[k]._ = bake(TOWERS[k], towerSize, dpr, '#c9a227');
    });
    const enemySize = tile * 0.72;
    const bossSize = tile * 0.95;
    cache.enemies.grunt = bake(ENEMIES.grunt, enemySize, dpr, '#a33b3b');
    cache.enemies.boss = bake(ENEMIES.boss, bossSize, dpr, '#c23b3b');
    cache.enemies.flyer = bake(ENEMIES.flyer, enemySize, dpr, '#6b7c93');
